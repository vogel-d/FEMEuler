...
function discGalerkinEdges!(M::Array{Float64,2},
                            degFT::degF{1,:H1},phiT::Array{Array{Float64,2},1}, phiTtrans::Array{Array{Array{Float64,1},2},1}, globalNumT1::Array{Int64,1}, globalNumT2::Array{Int64,1},
                            degFF::degF{2,:H1xH1},phiF::Array{Array{Float64,2},2}, phiFtrans::Array{Array{Array{Float64,1},2},1}, fval::SparseVector{Float64,Int64}, globalNumF1::Array{Int64,1}, globalNumF2::Array{Int64,1},
                            degFW::degF{1,:H1},phiW::Array{Array{Float64,2},1}, phiWtrans::Array{Array{Array{Float64,1},2},1}, wval::Array{Float64,1}, globalNumW1::Array{Int64,1}, globalNumW2::Array{Int64,1},
                            m::mesh, quadWeights::Array{Float64,1}, nquadPoints::Array{Array{Float64,2},1}, edgeData::Array{Array{Int64,1},1},gamma::Float64, coord::Array{Float64,2})
    ...
    #ddJe1=Array{Float64,1}(undef,sk);
    #ddJe2=Array{Float64,1}(undef,sk);
    jn1=initJacobi((m.geometry.dim,1),sk);
    jn2=initJacobi((m.geometry.dim,1),sk);
    ...
    for e in 1:length(edgeData[1])
        ...
        #jacobi!(ddJe1,m,inc1,n1,kubPn1,coord);
        #jacobi!(ddJe2,m,inc2,n2,kubPn2,coord);
        jacobi!(n1,m,inc1,kubPn1,jn1,coord);
        jacobi!(n2,m,inc2,kubPn2,jn2,coord);
        ...
        for j in 1:nF
            for i in 1:nT
                for r in 1:sk
                    lM11[i,j]+=quadWeights[r]*w1[r]*phiTn1[i][r]*(jn1[1][r]*phiFn1[1,j][r]+jn1[2][r]*phiFn1[2,j][r]);
                    lM12[i,j]+=quadWeights[r]*w2[r]*phiTn1[i][r]*(jn2[1][r]*phiFn2[1,j][r]+jn2[2][r]*phiFn2[2,j][r]);
                    lM21[i,j]+=quadWeights[r]*w1[r]*phiTn2[i][r]*(jn1[1][r]*phiFn1[1,j][r]+jn1[2][r]*phiFn1[2,j][r]);
                    lM22[i,j]+=quadWeights[r]*w2[r]*phiTn2[i][r]*(jn2[1][r]*phiFn2[1,j][r]+jn2[2][r]*phiFn2[2,j][r]);
                    #=
                    lM11[i,j]+=le*quadWeights[r]*w1[r]*phiTn1[i][r]*ddJe1[r]*(n1[1]*phiFn1[1,j][r]+n1[2]*phiFn1[2,j][r]);
                    lM12[i,j]+=le*quadWeights[r]*w2[r]*phiTn1[i][r]*ddJe2[r]*(n2[1]*phiFn2[1,j][r]+n2[2]*phiFn2[2,j][r]);
                    lM21[i,j]+=le*quadWeights[r]*w1[r]*phiTn2[i][r]*ddJe1[r]*(n1[1]*phiFn1[1,j][r]+n1[2]*phiFn1[2,j][r]);
...
function discGalerkinEdges!(rows::Array{Int64,1}, cols::Array{Int64,1}, vals::Array{Float64,1},
                            degFT::degF{1,:H1},phiT::Array{Array{Float64,2},1}, phiTtrans::Array{Array{Array{Float64,1},2},1}, globalNumT1::Array{Int64,1}, globalNumT2::Array{Int64,1},
                            degFF::degF{2,:H1xH1},phiF::Array{Array{Float64,2},2}, phiFtrans::Array{Array{Array{Float64,1},2},1}, fval::Array{Float64,1}, globalNumF1::Array{Int64,1}, globalNumF2::Array{Int64,1},
                            degFW::degF{1,:H1},phiW::Array{Array{Float64,2},1}, phiWtrans::Array{Array{Array{Float64,1},2},1}, wval::Array{Float64,1}, globalNumW1::Array{Int64,1}, globalNumW2::Array{Int64,1},
                            m::mesh, quadWeights::Array{Float64,1}, nquadPoints::Array{Array{Float64,2},1}, edgeData::Array{Array{Int64,1},1},gamma::Float64, coord::Array{Float64,2})
...
function discGalerkinEdges!(M::Array{Float64,2},
                            degFT::degF{2,:H1xH1},phiT::Array{Array{Float64,2},2}, phiTtrans::Array{Array{Array{Float64,1},2},1}, globalNumT1::Array{Int64,1}, globalNumT2::Array{Int64,1},
                            degFF::degF{2,:H1xH1},phiF::Array{Array{Float64,2},2}, phiFtrans::Array{Array{Array{Float64,1},2},1}, fval::SparseVector{Float64,Int64}, globalNumF1::Array{Int64,1}, globalNumF2::Array{Int64,1},
                            degFW::degF{2,:H1xH1},phiW::Array{Array{Float64,2},2}, phiWtrans::Array{Array{Array{Float64,1},2},1}, wval::Array{Float64,1}, globalNumW1::Array{Int64,1}, globalNumW2::Array{Int64,1},
                            m::mesh, quadWeights::Array{Float64,1}, nquadPoints::Array{Array{Float64,2},1}, edgeData::Array{Array{Int64,1},1},gamma::Float64, coord::Array{Float64,2})
    ...
    for e in 1:length(edgeData[1])
        ...
        for j in 1:nF
            for i in 1:nT
                for r in 1:length(quadWeights)
                    w1phiTn1=0.0; w2phiTn1=0.0; w1phiTn2=0.0; w2phiTn2=0.0;
                    for d in 1:m.geometry.dim
                        w1phiTn1+=w1[d][r]*phiTn1[d,i][r];
                        w2phiTn1+=w2[d][r]*phiTn1[d,i][r];
                        w1phiTn2+=w1[d][r]*phiTn2[d,i][r];
                        w2phiTn2+=w2[d][r]*phiTn2[d,i][r];
                    end
                    lM11[i,j]+=quadWeights[r]*(jn1[1][r]*phiFn1[1,j][r]+jn1[2][r]*phiFn1[2,j][r])*w1phiTn1;
                    lM12[i,j]+=quadWeights[r]*(jn2[1][r]*phiFn2[1,j][r]+jn2[2][r]*phiFn2[2,j][r])*w2phiTn1;
                    lM21[i,j]+=quadWeights[r]*(jn1[1][r]*phiFn1[1,j][r]+jn1[2][r]*phiFn1[2,j][r])*w1phiTn2;
                    lM22[i,j]+=quadWeights[r]*(jn2[1][r]*phiFn2[1,j][r]+jn2[2][r]*phiFn2[2,j][r])*w2phiTn2;
                    # piola: nphiF mit 1/Je = 1/Kantenlänge, phiW und phiT mit 1/dJ*J
                end
            end
        end
