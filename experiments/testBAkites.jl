...
function testBoussinesqAdvection()
  ...
  pv=femProblem(mHex, femType, compoundMethod=:HexToKites);
  m=splitCompoundMeshKites(pv);
  ...
  #unstructured_vtk(p, [0.0,500.0,1000.0,3000.0], [:p, :b, :v], ["Pressure", "Buoyancy", "Velocity"], "testBoussinesqAdvection/"*filename)
