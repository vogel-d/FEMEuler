            ...
            for j in 1:nCompoundPhiW
                for subj in 1:nSubPhiW
                    @. gradw1+=assembledPhiW[j][subj,subCell]*
                                        wval[globalNumW[j]]*gradphiW[1,subj]
                    @. gradw2+=assembledPhiW[j][subj,subCell]*
                                        wval[globalNumW[j]]*gradphiW[2,subj];
                end
            end
                    ...
                    for subi in 1:nSubPhiT
                        for subj in 1:nSubPhiF
                            for r in 1:size(kubWeights,2)
                                for l in 1:size(kubWeights,1)
                                    lM[i,j]+=assembledPhiT[i][subi,subCell]*assembledPhiF[j][subj,subCell]*
                                       kubWeights[l,r]*(ddJ[l,r]^3/abs(ddJ[l,r]))*(jphiT[1,subi][l,r]*(divphiF[subj][l,r]*w1[l,r]+gradw11[l,r]*phiF[1,subj][l,r]+gradw12[l,r]*phiF[2,subj][l,r])+jphiT[2,subi][l,r]*(divphiF[subj][l,r]*w2[l,r]+gradw21[l,r]*phiF[1,subj][l,r]+gradw22[l,r]*phiF[2,subj][l,r]));
                                end
                            end
                        end
                    end
