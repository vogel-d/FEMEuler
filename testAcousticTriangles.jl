...
function testAcousticTri()
    ...
    #m=generateRectMesh(100,100,:periodic,:periodic,0.0,100000.0,0.0,100000.0); #(east/west, top/bottom)
    m=generateTriMesh(100,100,:periodic,:constant,0.0,100000.0,0.0,100000.0); #(east/west, top/bottom)
    #m=generateTriMesh(3,3,:periodic,:periodic); #(east/west, top/bottom)
