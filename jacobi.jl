...
function jacobi!(J::Array{Array{AbstractFloat,2},2},dJ::Array{AbstractFloat,2},m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    ...
    elseif mt==4
         #J[1,1]=Array{AbstractFloat,2}(undef,sk,sk);
         #J[1,2]=Array{AbstractFloat,2}(undef,sk,sk);
         #J[2,1]=Array{AbstractFloat,2}(undef,sk,sk);
         #J[2,2]=Array{AbstractFloat,2}(undef,sk,sk);
         for i=1:sk, j=1:sk
...
function jacobi!(J::Array{AbstractFloat,2},dJ::AbstractFloat,m::mesh, fid::Int, x::AbstractFloat, y::AbstractFloat, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
    z=1;
...
function jacobi!(J::Array{Array{AbstractFloat,2},2},ddJ::Array{AbstractFloat,2},jphi::Array{Array{AbstractFloat,2},2},m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, phi::Array{Array{AbstractFloat,2},2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
    z=1;
...
function jacobi!(ddJ::Array{AbstractFloat,2}, jphi::Array{Array{AbstractFloat,2},2}, m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, phi::Array{Array{AbstractFloat,2},2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
...
function jacobi!(J::Array{Array{AbstractFloat,2},2},ddJ::Array{AbstractFloat,2},jphi::Array{Array{AbstractFloat,2},2},jpsi::Array{Array{AbstractFloat,2},2},m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, phi::Array{Array{AbstractFloat,2},2}, psi::Array{Array{AbstractFloat,2},2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
...
function jacobi!(J::Array{Array{AbstractFloat,1},2},dJ::Array{AbstractFloat,1},m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
    z=1;
    ...
    elseif mt==4
         #J[1,1]=Array{AbstractFloat,1}(undef,sk);
         #J[1,2]=Array{AbstractFloat,1}(undef,sk);
         #J[2,1]=Array{AbstractFloat,1}(undef,sk);
         #J[2,2]=Array{AbstractFloat,1}(undef,sk);
         for i=1:sk
...
function jacobi!(J::Array{Array{AbstractFloat,1},2},ddJ::Array{AbstractFloat,1},jphi::Array{Array{AbstractFloat,1},2},jpsi::Array{Array{AbstractFloat,1},2},m::mesh, fid::Int, kubPoints::Array{AbstractFloat,2}, phi::Array{Array{AbstractFloat,1},2}, psi::Array{Array{AbstractFloat,1},2}, coord::Array{AbstractFloat,2})
    key="20";
    mt=m.meshType;
    rstart=m.topology.offset[key][fid];
    z=1;
