...
function jacobi!(J::Array{Array{Float64,2},2},dJ::Array{Float64,2},m::mesh, fid::Int64, kubPoints::Array{Float64,2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:(rstart+mt-1)]];
...
function jacobi!(J::Array{Array{Float64,2},2},ddJ::Array{Float64,2},jphi::Array{Array{Float64,2},2},m::mesh, fid::Int64, kubPoints::Array{Float64,2}, phi::Array{Array{Float64,2},2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:rstart+mt-1]];
...
function jacobi!(ddJ::Array{Float64,2}, jphi::Array{Array{Float64,2},2}, m::mesh, fid::Int64, kubPoints::Array{Float64,2}, phi::Array{Array{Float64,2},2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:rstart+mt-1]];
...
function jacobi!(J::Array{Array{Float64,2},2},ddJ::Array{Float64,2},jphi::Array{Array{Float64,2},2},jpsi::Array{Array{Float64,2},2},m::mesh, fid::Int64, kubPoints::Array{Float64,2}, phi::Array{Array{Float64,2},2}, psi::Array{Array{Float64,2},2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:rstart+mt-1]];
...
function jacobi!(J::Array{Array{Float64,1},2},dJ::Array{Float64,1},m::mesh, fid::Int64, kubPoints::Array{Float64,2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:(rstart+mt-1)]];
...
function jacobi!(J::Array{Array{Float64,1},2},ddJ::Array{Float64,1},jphi::Array{Array{Float64,1},2},jpsi::Array{Array{Float64,1},2},m::mesh, fid::Int64, kubPoints::Array{Float64,2}, phi::Array{Array{Float64,1},2}, psi::Array{Array{Float64,1},2})
    key="20";
    mt=m.topology.offset[key][2]-m.topology.offset[key][1];
    rstart=m.topology.offset[key][fid];
    coord=@views m.geometry.coordinates[:,m.topology.incidence[key][rstart:rstart+mt-1]];
