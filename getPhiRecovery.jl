...
function getPhiRecovery(m::Array{Float64,1},recoverySpace::Val{:VecR1})
...
function getPhiRecovery(m::Array{Float64,1},recoverySpace::Val{:VecR1S})
...
function getPhiRecovery(m::Array{Float64,1},recoverySpace::Val{:VecR2})
...
function getPhiRecovery(m::Array{Float64,1},recoverySpace::Val{:VecR2S})
